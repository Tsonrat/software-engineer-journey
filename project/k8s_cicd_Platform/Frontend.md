...
<img width="1907" height="887" alt="Home" src="https://github.com/user-attachments/assets/5564495a-6dac-4244-884f-92a4505a318c" />
...
<img width="606" height="504" alt="Login page" src="https://github.com/user-attachments/assets/9261e3b6-d33f-40a7-ba1b-5e1f7b94025c" />
...
使用者從 Registry Explorer 選擇 Image Tag 後，可以建立平台管理的 Artifact。前端會請求後端解析該 Tag 的 OCI Manifest，取得可用的 Platform 與對應 Digest，再由使用者選擇需要納入管理的 Platform。。
